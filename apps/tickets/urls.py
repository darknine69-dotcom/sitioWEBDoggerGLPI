...
urlpatterns = [
    ...
    path("mi-panel/api/tickets/<int:pk>/info/", views.mi_ticket_info_ajax, name="mi_api_info"),
    path("mi-panel/api/tickets/<int:pk>/editar/", views.mi_ticket_editar_ajax, name="mi_api_editar"),
    path("mi-panel/api/tickets/<int:pk>/cerrar/", views.mi_ticket_cerrar_ajax, name="mi_api_cerrar"),
    path("mi-panel/api/tickets/<int:pk>/eliminar/", views.mi_ticket_eliminar_ajax, name="mi_api_eliminar"),
    ...
    path("panel/tecnico/mis-tickets/", views.mis_tickets_tecnico, name="mis_tickets"),
    path("panel/tecnico/tomar/<int:pk>/", views.panel_tecnico_tomar, name="panel_tecnico_tomar"),
    path("panel/tecnico/lote/", views.panel_tecnico_lote, name="panel_tecnico_lote"),
